...
app.layout = html.Div(
    children=[
    html.H1('Stocks comparison(Closing price)', style={'textAlign': 'center', 'color': 'rgb(80, 200, 150)', 'font-size': 30}),
    ...
    html.Div([
        ...
        html.Div(dcc.Input(id = 'input-s1', placeholder='Enter a stock ticker.',type='text',value='aapl',style = {'width':700, 'height':35,'margin-left':45}))
        ],style={'display':'flex', 'flex-direction':'row' ,'align-items':'center'}),

    html.Div([
        #html.P('Stock 2:', style = {'font-size':20, 'margin-left': 60 ,'margin-right': 5, 'margin-top':9, 'color':'red'}),
        html.Div(dcc.Input(id = 'input-s2', placeholder='Enter a stock ticker.',type='text',value='GOOGL',style = {'width':700, 'height': 35, 'margin-right': 28,'margin-left':45,})),
    ...
    html.Div( dbc.Card([ dbc.CardBody(dash_table.DataTable(id = 'corr', style_table={'color':'black'}, 
                                                           style_header={'backgroundColor': 'rgb(30, 30, 30)', 'color': 'white'}, style_data={'backgroundColor': 'rgb(50, 50, 50)', 'color': 'rgb(80, 200, 150)'} ))] ), style = {'margin-right':18, 'margin-left':20}),
